...
function AddressItem({ setAddressDefault = { setAddressDefault }, data = {}, setListAddress = () => {} }) {
    ...
    return (
        <div className="flex justify-between items-start gap-20 p-4 rounded-md hover:brightness-125 backdrop-blur-3xl bg-bg-light-menu dark:bg-bg-dark-menu">
            ...
            <div className="flex flex-col items-end justify-end gap-4">
                ...
                <Button className="text-primary bg-btn-second pl-5 pr-5 p-2 rounded-md">Chọn</Button>
            </div>
        </div>
    );
}
