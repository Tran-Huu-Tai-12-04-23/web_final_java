...
function Banner() {
    return (
        <>
            <AnimateOpacity className="flex justify-between items-center p-4 m-auto xl:w-3/4 lg:w-2/3 w-full">
